...
Future<Uint8List> generateThumbnail(List<StrokeEntity> strokeList, double width, double height) async {
  ...
  for (final stroke in strokeList) {
    for (final point in stroke.pointList) {
